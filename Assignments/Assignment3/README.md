...
-We observed that exits pertaining to exit code **29-MOV DR** occured least number of times **2 times** while exits for exit code **48-EPT violation** were frequent with count **2,14,059**
